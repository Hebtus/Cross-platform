              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    DateTime startDate=new DateTime(int.parse(startTime.substring(0,3)),int.parse(startTime.substring(5,6)), int.parse(startTime.substring(8,9)), int.parse(startTimeController.text.substring(0,1)), int.parse(startTimeController.text.substring(3,4)), 0, 0);
                    DateTime endDate=new DateTime(int.parse(endTime.substring(0,3)),int.parse(endTime.substring(5,6)), int.parse(endTime.substring(8,9)), int.parse(endTimeController.text.substring(0,1)), int.parse(endTimeController.text.substring(3,4)), 0, 0);
                    CreatorTicket ticketData=new CreatorTicket(name: nameController.text, type: "paid", price: int.parse(priceController.text), capacity:int.parse(quntatityController.text), sellingStartTime: startDate, sellingEndTime: endDate);
