  ...
  Future _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDatePublish) {
      setState(() {
        ...
        _date.value =
            TextEditingValue(text: "${selectedDatePublish.toLocal()}".split(' ')[0]);
      });
    }
  }
  @override
                ...
                children: [
                  ...
                  Padding(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      Text("testing website"
                                                        ,style: TextStyle(
                                                            fontSize: 20,
                                                          fontWeight: FontWeight.bold,
                                                        ),),
                                                      SizedBox(height: 5,),
                                                      Text("Saturday, April 15, 2023 at 7:00 PM EET",
                    ...
                    DropdownButton(
                      ...
                      iconSize: 30.0,
                      style: TextStyle(color: Colors.blue),
                      items: ['Any one with link', 'only people with the password'].map(
                            (val) {
                    ...
                    SizedBox(
                      height:10 ,
                        ...
                        Text("Will this event ever be public?" ,
                          style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        Text("Time zone is the same as your event's" ,
                          style: TextStyle(
                            fontSize: 15,
                          ),
                        ),
