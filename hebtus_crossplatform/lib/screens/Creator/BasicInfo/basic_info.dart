      ...
      return Column(
        ...
        children: [
          ...
          if (buttonSingleEvent) ...[
            ...
            TextFormField(
              enabled: false,
              initialValue: widget.eventdetails.startTime.toString().substring(0,10),
              decoration: InputDecoration(
                border: const OutlineInputBorder(),
            ...
            TextFormField(
              initialValue: widget.eventdetails.startTime.hour.toString()+":"+widget.eventdetails.startTime.minute.toString(),
              enabled: false,
            ...
            TextFormField(
              enabled: false,
              initialValue:widget.eventdetails.endTime.toString().substring(0,10),
              decoration: InputDecoration(
                border: const OutlineInputBorder(),
                hintText: 'Event ends',
                prefixIcon: IconButton(
            ...
            TextFormField(
              enabled: false,
              initialValue: widget.eventdetails.endTime.hour.toString()+":"+widget.eventdetails.endTime.minute.toString(),
              decoration: const InputDecoration(
                border: OutlineInputBorder(),
                hintText: 'End time',
              ),
  ...
  //////////////////////////////////////////////////////////////////////////
                  imageUpload(widget.eventdetails.imgURL),
                    ...
                    TextField(
                      ...
                      maxLines: null, // allows the user to enter multiple lines of text
                      keyboardType: TextInputType.multiline, // allows the keyboard to show a multiline input
                      onChanged: (value) {
