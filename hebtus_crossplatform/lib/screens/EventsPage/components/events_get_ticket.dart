                 ...
                 Container(
                  child: Row(children: [
                    Padding(
                      ...
                      child: IconButton(onPressed: _incrementnumber, icon: const Icon(Icons.add),color: Colors.blue,),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(3),
                      child: Text("$_number"),
                    ),
                    IconButton(onPressed: _decrementnumber, icon: const Icon(Icons.minimize),color: Colors.blue,),
                  ],),
                 )
                ],
              ),
